...
//  Futsteps
//
//  Created by Alikeju Adejo on 8/30/17.
...
class CreateAccountViewController: UIViewController{
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if (segue.identifier == "joinOrg"){
            let showAddOrgTableViewController = segue.destination as! AddOrgTableViewController
            showAddOrgTableViewController.loggedInUser = self.loggedInUser as? FIRUser
        }
    }
